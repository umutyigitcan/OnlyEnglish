        ...
        tasarim.asikki.setOnClickListener {
            if (tasarim.asikki.text == dogrucevap) {
                ...
                if(bitis==0){
                    ...
                    Toast.makeText(context,"Tebrikler 5.levele geçtiniz!",Toast.LENGTH_SHORT).show()
                    Navigation.findNavController(it).navigate(R.id.action_resimliTestDort_to_resimliTestMenu)
                }
            }
            else{

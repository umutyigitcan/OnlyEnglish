        ...
        tasarim.asikki.setOnClickListener {
            if (tasarim.asikki.text == dogrucevap) {
                ...
                if(bitis==0){
                    ...
                    Toast.makeText(context,"Tebrikler 8.levele geçtiniz!",Toast.LENGTH_SHORT).show()
                    Navigation.findNavController(it).navigate(R.id.action_resimliTestYedi_to_resimliTestMenu)
                }
            }
            else{
